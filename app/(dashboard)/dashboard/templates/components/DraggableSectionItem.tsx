...
export function DraggableSectionItem({
  ...
  return (
    <div 
      ref={setNodeRef} 
      style={style} 
      className={`border border-hairline-light rounded-2xl overflow-hidden bg-white shadow-sm transition-shadow duration-200 ${isDragging ? 'shadow-md ring-2 ring-primary/20' : ''}`}
    >
      {/* Accordion Header */}
