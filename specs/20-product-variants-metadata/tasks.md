...
- [X] T082 [P] Add keyboard navigation to the inline variant table at `components/dashboard/product-variant-editor/VariantsSection.tsx` — Tab between cells, Enter to edit, Escape to cancel, Arrow keys for cell navigation, ARIA role="grid" / role="gridcell"
...
- [X] T085 [P] Add scroll virtualization or pagination to the variant table — when variant count > 50, show 25 per page with pagination controls or virtual scroll at `components/dashboard/product-variant-editor/VariantsSection.tsx`
