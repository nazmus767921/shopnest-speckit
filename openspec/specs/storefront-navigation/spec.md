...
Configure dynamic navigation menus and nested links for storefront templates. Merchants can manage header and footer menus that templates render dynamically.
