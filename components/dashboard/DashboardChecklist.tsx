...
export function DashboardChecklist({
  ...
  const onboardingSteps: ChecklistStep[] = [
    ...
    { title: "Select boutique subdomain", done: true },
    { title: "Add your first product catalog listing", done: activeProductsCount > 0, href: "/dashboard/products" },
    { title: "Configure bKash / Nagad merchant details", done: hasPaymentConfigured, href: "/dashboard/settings" },
    { title: "Configure shipping zones and delivery rates", done: hasShippingConfigured, href: "/dashboard/settings" },
    { title: "Share storefront URL on social networks", done: false },
  ]
      ...
      <div className="border border-border bg-card p-6 rounded-xl flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3.5 mt-2">
          {onboardingSteps.map((step, idx) => {
            const isShareStep = idx === onboardingSteps.length - 1
