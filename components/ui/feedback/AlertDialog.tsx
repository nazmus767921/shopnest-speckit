...
export function AlertDialog({
  ...
  return createPortal(
    <div 
      className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/40 backdrop-blur-xs select-text pb-[calc(env(safe-area-inset-bottom)+1rem)]"
      onClick={(e) => {
